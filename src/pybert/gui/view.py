    ...
    Group(
        ...
        VGroup(
            HGroup(
                ...
                VGroup(
                    Item(name="max_mag_tune",     label="Max. (dB)",  tooltip="CTLE maximum peaking magnitude (dB)",
                         format_str="%4.1f",),
                    ...
                    Item(name="ctle_offset_tune", label="Offset",     tooltip="CTLE d.c. offset (dB)",
                         enabled_when='ctle_mode_tune == "Manual"',),
                    Item(name="peak_mag_tune",    label="Boost (dB)", tooltip="CTLE peaking magnitude (dB)",
                         format_str="%4.1f",),
                    label="Rx CTLE",
                    show_border=True,
                ),
