        ...
        VGroup(
            HGroup(
                ...
                VGroup(
                    ...
                    HGroup(
                        Item(name="min_mag_tune", label="Min. (dB)", tooltip="CTLE peaking magnitude minimum (dB)",
                             format_str="%4.1f", enabled_when="ctle_enable_tune",),
                        Item(label="dB"),
                    ),
                    HGroup(
                        Item(name="max_mag_tune", label="Max. (dB)", tooltip="CTLE peaking magnitude maximum (dB)",
                             format_str="%4.1f", enabled_when="ctle_enable_tune",),
                        Item(label="dB"),
                    ),
                    HGroup(
                        Item(name="step_mag_tune", label="Step (dB)", tooltip="CTLE peaking magnitude step (dB)",
                             format_str="%4.1f", enabled_when="ctle_enable_tune",),
                        Item(label="dB"),
                    ),
                    HGroup(
                        Item(name="peak_mag_tune", label="Boost (dB)", tooltip="CTLE peaking magnitude result (dB)",
