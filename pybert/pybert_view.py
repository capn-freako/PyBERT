        ...
        VGroup(
            HGroup(
                VGroup(
                    ...
                    Item(name='eye_bits', label='EyeBits'),
                    label='Simulation Control', show_border=True,
                ),
                VGroup(
                    Item(name='vod',     label='Vod (V)', ),
                    Item(name='rs',      label='Rs (Ohms)', ),
                    Item(name='cout',    label='Cout (pF)', ),
                    Item(name='pn_mag',  label='Pn (V)', ),
                    Item(name='pn_freq', label='f(Pn) (MHz)', ),
                    label='Tx Parameters', show_border=True,
                ),
                VGroup(
                    Item(name='z0',      label='Z0 (Ohms)',  show_label=True, enabled_when='True'),
                    Item(name='fc',      label='fc (GHz)',   show_label=True, enabled_when='True'),
                    Item(name='rn',      label='Rn (V)',     show_label=True, enabled_when='True'),
                    Item(name='rin',     label='Rin (Ohms)', ),
                    Item(name='cin',     label='Cin (pF)', ),
                    label='Channel/Rx Parameters', show_border=True,
                ),
                VGroup(
