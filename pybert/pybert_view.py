...
class MyView(HasTraits):
    """A custom ``View``, to allow sending in solver list,
    which is required for proper initialization.
    """
                        ...
                        VGroup(  # Channel Designer
                            HGroup(
                                ...
                                Item(
                                    ...
                                    label="Native",
                                    enabled_when="use_ch_file == False",
                                    tooltip="Use native channel parameters.",
                                ),
                                HGroup(
                                    Item(
                                        name="Theta0",
                            ...
                            HGroup(
                                VGroup(
                                    ...
                                    show_border=True,
                                    enabled_when="use_ch_file == False and use_native == False",
                                ),
                                VGroup(
